...
public class UntagCommandParserTest {
    ...
    public void parse_validArgs_returnsUntagCommand() throws Exception {
        ...
        assertParseSuccess(parser, "1 friends", new UntagCommand(INDEX_FIRST_PERSON, tags));
    }
    ...
    public void parse_validArgsMultipleTags_returnsUntagCommand() throws Exception {
        ...
        assertParseSuccess(parser, "1 friends colleagues family", new UntagCommand(INDEX_FIRST_PERSON, tags));
    }
    ...
    public void parse_multipleTagsWithSpaces_success() throws Exception {
        ...
        assertParseSuccess(parser, "1   tag1  tag2    tag3", new UntagCommand(INDEX_FIRST_PERSON, tags));
    }
    ...
    public void parse_largeIndex_success() throws Exception {
        ...
        assertParseSuccess(parser, "999 friends", new UntagCommand(Index.fromOneBased(999), tags));
    }
    ...
    public void parse_emptyTagAfterTrim_throwsParseException() {
        ...
        // but this ensures the isEmpty() check in UntagCommandParser is covered

        // Tags that are only whitespace should be caught by Tag validation
        // This will throw MESSAGE_INVALID_COMMAND_FORMAT, not MESSAGE_NO_TAGS_PROVIDED
        // because the tokens.length < 2 check catches this before we reach parseTags
        assertParseFailure(parser, "1  ", String.format(MESSAGE_INVALID_COMMAND_FORMAT,
                UntagCommand.MESSAGE_USAGE));
    }
}
