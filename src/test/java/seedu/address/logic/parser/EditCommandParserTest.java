...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, VALID_EMPLOYEE_ID_1 + INVALID_TAG_DESC,
        ...
        assertParseFailure(parser, VALID_EMPLOYEE_ID_1 + TAG_DESC_FRIEND + TAG_DESC_HUSBAND + TAG_EMPTY,
                Tag.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, VALID_EMPLOYEE_ID_1 + TAG_DESC_FRIEND + TAG_EMPTY + TAG_DESC_HUSBAND,
                Tag.MESSAGE_CONSTRAINTS);
        assertParseFailure(parser, VALID_EMPLOYEE_ID_1 + TAG_EMPTY + TAG_DESC_FRIEND + TAG_DESC_HUSBAND,
                Tag.MESSAGE_CONSTRAINTS);
    ...
    public void parse_allFieldsSpecified_success() {
        String userInput = VALID_EMPLOYEE_ID_2 + PHONE_DESC_BOB + TAG_DESC_HUSBAND
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // tags
        userInput = VALID_EMPLOYEE_ID_3 + TAG_DESC_FRIEND;
    ...
    public void parse_resetTags_success() {
        String userInput = VALID_EMPLOYEE_ID_3 + TAG_EMPTY;
