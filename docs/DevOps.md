...
1. Update the version number in [`MainApp.java`](https://github.com/se-edu/AY2526S1-CS2103-F12-1/tp/blob/tree/master/src/main/java/seedu/address/MainApp.java).
